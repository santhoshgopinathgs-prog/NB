    ...
    <div className="animate-slide-up" style={{ padding: '0 0px 20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div className="portrait-roadmap-canvas">
        ...
        {ANEKAL_LEVELS.map((lvl, index) => {
          ...
          // Curved winding path positions (left %, top %) matching the 10 stone platforms in the new background image (Level 1 near school building at bottom to Level 10 near archway at top)
          const nodePositions = [
            { left: '60%', top: '72.5%' }, // 1. Basics of Computer
            { left: '42%', top: '65.5%' }, // 2. Typing Champ
            { left: '64%', top: '57.5%' }, // 3. Internet Navigator
            { left: '41%', top: '49.5%' }, // 4. Digital Productivity
            { left: '63%', top: '42.0%' }, // 5. Online Safety
            { left: '42%', top: '34.0%' }, // 6. Mobile Literacy
            { left: '63%', top: '26.0%' }, // 7. Digital Creativity
            { left: '41%', top: '18.5%' }, // 8. Intro to Coding
            { left: '60%', top: '11.0%' }, // 9. Real Life Project
            { left: '46%', top: '4.5%' }   // 10. Graduation
          ];
